import { createMapFromArrays } from '../base'
...
const NAMED_TO_HEX6_MAP = createMapFromArrays(NAMED_COLOE_NAME, NAMED_COLOR_HEX6)
const HEX6_TO_NAMED_MAP = createMapFromArrays(NAMED_COLOR_HEX6, NAMED_COLOE_NAME)

// const REGEXP_RGBA_CSS = /rgba?\(\s*([\w.+]+)\s*,\s*([\w.+]+)\s*,\s*([\w.+]+)\s*(?:,\s*([\w%.+]+)\s*)?\)/ // check: https://regexr.com/4d4k4
// const REGEXP_RGBA_CSS = /rgba?\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)\s*(?:,\s*([\d.]+%?)\s*)?\)/
// const REGEXP_RGBA_CSS = /rgba?\(\s*([0-9]+(?:\.[0-9]+)?)\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*,\s*([0-9]+(?:\.[0-9]+)?)\s*(?:,\s*([0-9]+(?:\.[0-9]+)?|100%)\s*)?\)/;
// const REGEXP_HEX3_CSS = /#?([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])/
// const REGEXP_HEX6_CSS = /#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/
// const REGEXP_HEX8_CSS = /#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/
// const REGEXP_SHORT_HEX_CSS = /^#([0-9a-fA-f]{3})$/
...
type RgbSyntax = LegacyRgbSyntax | ModernRgbSyntax
type RgbaSyntax = LegacyRgbaSyntax | ModernRgbaSyntax

...
const baseRules = {
  ...
  'comma-dangle': ['error', {
    arrays: 'always-multiline', // arrays: 'never' // EDIT
    objects: 'always-multiline', // objects: 'never' // EDIT
    imports: 'always-multiline', // imports: 'never' // EDIT
    exports: 'always-multiline', // exports: 'never' // EDIT
    functions: 'always-multiline', // functions: 'never' // EDIT
  }],

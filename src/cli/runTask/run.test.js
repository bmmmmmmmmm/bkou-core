...
colorLog('\n📋 测试 3: io="inherit" - 实时显示不收集', ['cyan-bg'])
...
colorLog('\n📋 测试 7: 同时输出到 stdout 和 stderr', ['cyan-bg'])
...
colorLog('\n📋 测试 8: 独立获取 stdout/stderr Promise', ['cyan-bg'])

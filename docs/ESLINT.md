...
module.exports = {
  extends: [
    '@bkou/core/dev/eslint/__base__/eslint-config-base.cjs',
    '@bkou/core/dev/eslint/__typescript__/eslint-config-ts.cjs',
    '@bkou/core/dev/eslint/__react__/eslint-config-react.cjs',
  ],
};
```
...
```javascript
// eslint.config.mjs
import baseConfig from '@bkou/core/dev/eslint/__base__/eslint-config-base.flat.mjs'
import tsConfig from '@bkou/core/dev/eslint/__typescript__/eslint-config-ts.flat.mjs'
import reactConfig from '@bkou/core/dev/eslint/__react__/eslint-config-react.flat.mjs'
